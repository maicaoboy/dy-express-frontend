    ...
    <el-form ref="form" :model="goodsInfo" :rules="rules" label-position="right" label-width="150px">
      ...
      <el-form-item :label="$t('table.goodsInfo.publishStatus')" prop="publishStatus">
        <el-radio-group v-model="goodsInfo.publishStatus">
          <el-radio :label="0">
            {{ $t('table.goodsInfo.publishStatusEnum._0') }}
          </el-radio>
          <el-radio :label="1">
            {{ $t('table.goodsInfo.publishStatusEnum._1') }}
          </el-radio>
        </el-radio-group>
      </el-form-item>
      <el-form-item :label="$t('table.goodsInfo.auditStatus')" prop="auditStatus">
        <el-radio-group v-model="goodsInfo.auditStatus">
          <el-radio :label="0">
            {{ $t('table.goodsInfo.auditStatusEnum._0') }}
          </el-radio>
          <el-radio :label="1">
            {{ $t('table.goodsInfo.auditStatusEnum._1') }}
          </el-radio>
        </el-radio-group>
      </el-form-item>
      ...
      <el-form-item :label="$t('table.goodsInfo.productionDate')" prop="productionDate">
        <el-date-picker v-model="goodsInfo.productionDate" type="datetime" :placeholder="$t('table.goodsInfo.productionDate')" value-format="yyyy-MM-dd HH:mm:ss" @change="dataSearch" />
      </el-form-item>
