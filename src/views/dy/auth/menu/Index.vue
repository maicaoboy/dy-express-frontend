...
<script>
import commonTree from '@/components/dy/CommonTree.vue'
    ...
    menuComponent() {
      ...
      if (this.menu.path && this.menu.path !== '/') {
        ...
        if (isUrl) {
          ...
          comp = `前端组件：dy${this.menu.path}/Index.vue`
        }
      } else {
        comp = `前端组件：dy/Index.vue`
      }
      return comp
    }
  },
  ...
  methods: {
    ...
    computedComponent() {
      ...
      if (isUrl) {
        ...
        if (this.menu.path) {
          this.menu.component = `dy${this.menu.path}/Index`
        } else {
          this.menu.component = `dy/Index`
        }
      }
    },
    initMenuTree() {
